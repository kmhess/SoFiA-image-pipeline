...
def get_decals(hi_pos, opt_view=6*u.arcmin, decals='decals'):
    ...
    if decals == 'decaps':
        url = 'https://legacysurvey.org/viewer/cutout.fits?ra={}&dec={}&layer=decaps2&' \
              'pixscale={}&width={}&height={}&bands=r'.format(hi_pos.ra.deg, hi_pos.dec.deg, pixscale, dimen[0], dimen[-1])
    elif decals == 'dr9':
        ...
        url = 'https://www.legacysurvey.org/viewer/cutout.fits?ra={}&dec={}&layer=hsc-dr3&' \
              'pixscale={}&width={}&height={}&bands=g'.format(hi_pos.ra.deg, hi_pos.dec.deg, pixscale, dimen[0], dimen[-1])
    else:
        url = 'https://www.legacysurvey.org/viewer/cutout.fits?ra={}&dec={}&layer=ls-dr11&' \
              'pixscale={}&width={}&height={}&bands=g'.format(hi_pos.ra.deg, hi_pos.dec.deg, pixscale, dimen[0], dimen[-1])
